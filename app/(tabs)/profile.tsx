        ...
        <ScrollView>
          <View className="mb-5">
            <View className="flex flex-row items-center px-5 py-4">
              ...
              <View className="grow">
                <Text className="text-xl font-RobotoBold m-0 pl-2"> {user?.username} KS</Text>
                <Text className="text-sm font-Roboto pl-3 m-0 text-gray-500">{user?.emailAddresses[0].emailAddress}</Text>
              </View>
